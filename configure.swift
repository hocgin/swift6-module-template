...
try! fileManager.copyItem(atPath: "xxPROJECTxNAMExx", toPath: "OUTPUT/.tmp/xxPROJECTxNAMExx")
...
let pair = getPair("xxPROJECTxNAMExx")

//try! fileManager.copyItem(atPath: "OUTPUT/.tmp/xxPROJECTxNAMExx", toPath: "OUTPUT/\(pair?.to)")
