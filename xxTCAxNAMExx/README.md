...
THIS LIST IS EASY, CHECK IT OFF ONE-BY-ONE BABY! ✔️ ✔️ ✔️
 ...
 - [ ] Open the project in Xcode and add features to xxTCAxNAMExx
...
![GitHub tag (latest SemVer)](https://github.com/__GITHUB_USERNAME__/xxTCAxNAMExx/actions/workflows/ci.yml/badge.svg?branch=main)
...
xxTCAxNAMExx is available under the MIT license. See [the LICENSE file](LICENSE) for more information.
