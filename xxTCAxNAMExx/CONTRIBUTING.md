...
1. Confirm the build is [passing in GitHub Actions](https://github.com/__GITHUB_USERNAME__/xxTCAxNAMExx/actions)
2. Push a release commit
   1. Create a new Main section at the top
   2. Rename the old Main section like:
          ## [1.0.5](https://github.com/__GITHUB_USERNAME__/xxTCAxNAMExx/releases/tag/1.0.5)
